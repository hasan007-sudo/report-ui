...
export interface CEFRReportProps {
        ...
        <div className="flex h-[80vh] w-full flex-col gap-6 xl:grid xl:grid-cols-[auto_1fr]">
          ...
          >
            ...
            <Button
              variant="outline"
              size="icon"
              className="bg-background hover:bg-accent absolute top-1/2 left-[-20px] z-4 hidden h-10 w-10 -translate-y-1/2 cursor-pointer items-center justify-center rounded-full shadow-lg xl:flex"
